...
robot = URDF.from_xml_file("/home/yi/robotic_manipulation/peg_in_hole/ur3_rl_sim2real/gym_envs/models/ur3_robot.urdf")
...
def inverse(init_joint, goal_pose, goal_rot):
    ...
    ik_p_kdl = kdl.ChainIkSolverPos_NR(chain, fk, ik_v, maxiter=50, eps=math.pow(10, -3))
