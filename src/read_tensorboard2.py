...
axesSub.set_ylabel(axesSub.get_ylabel(), fontsize=14)
axesSub.set_xlabel(" ", fontsize=14)
axesSub.set_xlim(0,150)
axesSubsuc.set_xlim(0,150)
axesSubsuc.set_ylabel(axesSubsuc.get_ylabel(), fontsize=14)
axesSubsuc.set_xlabel(axesSubsuc.get_xlabel(), fontsize=14)
